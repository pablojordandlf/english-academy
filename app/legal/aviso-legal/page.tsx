...
export const metadata: Metadata = {
  title: "Aviso Legal | English Academy",
  description: "Aviso legal de English Academy. Información legal sobre nuestra plataforma de enseñanza de inglés con IA.",
};
        ...
        <div className="max-w-4xl mx-auto bg-gray-800/70 backdrop-blur-sm p-8 rounded-2xl border border-gray-700 shadow-lg">
          ...
          <div className="space-y-8 text-gray-300">
            <section>
              ...
              <p className="mt-2">
                <strong>Nombre/Razón Social:</strong> English Academy S.L.<br />
            ...
            <section>
              ...
              <p>
                ...
                del que es titular English Academy S.L.
              </p>
              <p className="mt-2">
                La navegación por el sitio web de English Academy atribuye la condición de usuario del mismo 
              ...
              <p className="mt-2">
                ...
                English Academy o frente a terceros, de cualesquiera daños y perjuicios que pudieran causarse como 
            ...
            <section>
              ...
              <p>
                El sitio web y sus servicios son de acceso libre y gratuito. No obstante, English Academy puede 
              ...
              <p className="mt-2">
                ...
                English Academy y será el único responsable de las manifestaciones falsas o inexactas que realice.
              </p>
              <p className="mt-2">
                El usuario se compromete expresamente a hacer un uso adecuado de los contenidos y servicios de 
                English Academy y a no emplearlos para, entre otros:
              </p>
              <ul className="list-disc pl-6 mt-3 space-y-2">
                ...
                <li>Introducir en la red virus informáticos o realizar actuaciones susceptibles de alterar, estropear, interrumpir o generar errores o daños en los documentos electrónicos, datos o sistemas físicos y lógicos de English Academy o de terceras personas.</li>
                <li>Intentar acceder a las cuentas de correo electrónico de otros usuarios o a áreas restringidas de los sistemas informáticos de English Academy o de terceros y, en su caso, extraer información.</li>
                <li>Vulnerar los derechos de propiedad intelectual o industrial, así como violar la confidencialidad de la información de English Academy o de terceros.</li>
            ...
            <section>
              ...
              <p>
                English Academy no se hace responsable, en ningún caso, de los daños y perjuicios de cualquier 
              ...
              <p className="mt-2">
                English Academy no garantiza que el sitio web y el servidor estén libres de virus y no se hace 
            ...
            <section>
              ...
              <p>
                El sitio web de English Academy puede incluir enlaces a otros sitios web gestionados por terceros.
              </p>
              <p className="mt-2">
                English Academy no ejerce ningún tipo de control sobre dichos sitios y contenidos, de modo que en 
            ...
            <section>
              ...
              <p>
                ...
                English Academy o de sus licenciantes.
              </p>
              <p className="mt-2">
              ...
              <p className="mt-2">
                ...
                de English Academy. Podrá visualizar los elementos del sitio web e incluso imprimirlos, copiarlos y 
                ...
                que estuviera instalado en las páginas de English Academy.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                English Academy se reserva la facultad de presentar las acciones civiles o penales que considere 
            ...
            <section>
              ...
              <p>
                La relación entre English Academy y el usuario se regirá por la normativa española vigente. Todas 
