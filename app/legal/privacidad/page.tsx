...
export const metadata: Metadata = {
  ...
  description: "Política de privacidad de English Academy. Conoce cómo recopilamos, utilizamos y protegemos tus datos personales.",
};
        ...
        <div className="max-w-4xl mx-auto bg-gray-800/70 backdrop-blur-sm p-8 rounded-2xl border border-gray-700 shadow-lg">
          ...
          <div className="space-y-8 text-gray-300">
            <section>
              ...
              <p>
                En English Academy ("nosotros", "nuestro" o "la empresa"), respetamos su privacidad y nos comprometemos a proteger 
            ...
            <section>
              ...
              <p>
                English Academy es el responsable del tratamiento de los datos personales que nos proporcione a través 
                de nuestra plataforma.
              </p>
              <p className="mt-2">
                <strong>Datos de contacto:</strong><br />
                English Academy S.L.<br />
